...
class ReceptionistAnnouncementWidget extends StatefulWidget {
  const ReceptionistAnnouncementWidget({super.key});

  static String routeName = 'ReceptionistAnnouncement';
  static String routePath = '/receptionistAnnouncement';

  @override
  State<ReceptionistAnnouncementWidget> createState() =>
      _ReceptionistAnnouncementWidgetState();
}
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: List.generate(
                            columnNotificationRecordList.length, (columnIndex) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  ViewAnnouncementWidget.routeName,
                                  queryParameters: {
                                    'notificationid': serializeParam(
                                      columnNotificationRecord.reference,
