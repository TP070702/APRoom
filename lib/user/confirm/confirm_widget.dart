...
class ConfirmWidget extends StatefulWidget {
  ...
  static String routePath = '/confirm';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BookingRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final confirmBookingRecord = snapshot.data!;
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 24.0, 0.0, 0.0),
                  child: Text(
                    'Room: ${confirmBookingRecord.roomID}',
                ...
                Padding(
                  ...
                  child: Text(
                    'Thank you! The booking has been confirmed. Please arrive on time and remember to check for belongings!',
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 4.0),
                                  child: Text(
                                    'Booked Date:${dateTimeFormat("EEEE, dd/MM/yyyy", confirmBookingRecord.bookingDate)}',
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 4.0),
                                  child: Text(
                                    confirmBookingRecord.bookingTime,
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          font: GoogleFonts.plusJakartaSans(
