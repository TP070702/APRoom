...
class ViewAnnouncementWidget extends StatefulWidget {
  ...
  final DocumentReference? notificationid;

  static String routeName = 'ViewAnnouncement';
  static String routePath = '/viewAnnouncement';
...
class _ViewAnnouncementWidgetState extends State<ViewAnnouncementWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<NotificationRecord>(
      stream: NotificationRecord.getDocument(widget.notificationid!),
      builder: (context, snapshot) {
        ...
        final viewAnnouncementNotificationRecord = snapshot.data!;
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                24.0, 4.0, 24.0, 12.0),
                            child: Text(
                              viewAnnouncementNotificationRecord.message,
                              textAlign: TextAlign.start,
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
